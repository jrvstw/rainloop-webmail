...
class AdminApp extends AbstractApp {
	...
	reloadBlockedAccountList() {
		BlockedAccountStore.blockedAccounts.loading(true);
		Remote.blockedAccountList((result, data) => {
			BlockedAccountStore.blockedAccounts.loading(false);
			if (StorageResultType.Success === result && data && data.Result) {
				BlockedAccountStore.blockedAccounts(
